...
| Constellation overview | **Partial** | Window enumeration, focus, close and workspace movement work. A DWM thumbnail service (registry-owned handles, cleanup on re-layout, overlay clear and source destruction via the event fabric) composites live previews over the card bodies, with the identity tile as the honest fallback; cards straightened to exposé grammar. Native visual verification and the leak-soak remain before this flips Complete. |
