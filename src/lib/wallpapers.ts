...
export const WALLPAPERS: readonly WallpaperSpec[] = [
  ...
  },
  {
    id: "orbital-bloom",
    name: "Orbital Bloom",
    description: "Glass-light arcs flower around a quiet gravitational core.",
    kind: "image",
    dark: "/wallpapers/orbital-bloom-dark.png",
    light: "/wallpapers/orbital-bloom-light.png",
    preview: "linear-gradient(145deg, #080d20, #303a79 52%, #e6ad83)",
  },
  {
    id: "glacial-lensing",
    name: "Glacial Lensing",
    description: "Crystalline terrain bends a distant polar horizon.",
    kind: "image",
    dark: "/wallpapers/glacial-lensing-dark.png",
    light: "/wallpapers/glacial-lensing-light.png",
    preview: "linear-gradient(145deg, #03101a, #0d6674 58%, #f18c72)",
  },
  {
    id: "live-field",
    name: "Living Field",
